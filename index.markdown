...
I did try disabling AMSI, but my guess is Cortex is using its own inspection engine and not relying on AMSI, which is probably a good decision since AMSI seems to be notoriously easy to disable. See [https://amsi.fail](https://amsi.fail).
