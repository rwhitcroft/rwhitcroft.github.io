...
With the protection changed, I should now be able to write artbirary values (bytes) to the address of the entrypoint. When I did this originally, I fulled expected S1 to intervene and kill my process. I don't have a guess as to why S1 allows you to do this.
